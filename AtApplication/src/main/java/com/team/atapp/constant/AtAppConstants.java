package com.team.atapp.constant;
...
public class AtAppConstants {
	...
	public static final String TTL_LOGIN_KEY = "atapp.token.login.ttlmillis";
	
	public static final String KEY_ATAPP_MOBILE = "ATAPP_MOBILE";
